...
/** Small chevron pointing along the active step's route, slowly pulsing — a
 *  "here's your current leg" indicator, independent of and on top of the
 *  draggable via-point markers below. `bearingDeg` is the direction of
 *  travel (0 = north, clockwise), applied as a CSS rotation since MapLibre
 *  markers don't rotate themselves. */
